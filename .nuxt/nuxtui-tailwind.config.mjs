      ...
      import { customSafelistExtractor, generateSafelist } from "D:/me-coffee-qr/node_modules/@nuxt/ui/dist/runtime/utils/colors";
      ...
      export default {
        ...
        content: {
          files: [
            "D:/me-coffee-qr/node_modules/@nuxt/ui/dist/runtime/components/**/*.{vue,mjs,ts}",
            "D:/me-coffee-qr/node_modules/@nuxt/ui/dist/runtime/ui.config/**/*.{mjs,js,ts}"
          ],
          transform: {
            vue: (content) => {
